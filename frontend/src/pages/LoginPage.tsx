...
const LoginPage: React.FC = () => {
    ...
    const loadRememberedCredentials = () => {
        ...
        const rememberedLoginType = localStorage.getItem(STORAGE_KEYS.REMEMBER_LOGIN_TYPE) as 'email' | 'username';
    ...
    const handleRememberCredentials = (identifier: string, loginType: 'email' | 'username', remember: boolean) => {
        if (remember && identifier.trim()) {
            if (loginType === 'email') {
                localStorage.setItem(STORAGE_KEYS.REMEMBER_EMAIL, identifier);
                localStorage.setItem(STORAGE_KEYS.REMEMBER_LOGIN_TYPE, 'email');
                // Clear username if switching to email
                localStorage.removeItem(STORAGE_KEYS.REMEMBER_USERNAME);
            } else {
                localStorage.setItem(STORAGE_KEYS.REMEMBER_USERNAME, identifier);
                localStorage.setItem(STORAGE_KEYS.REMEMBER_LOGIN_TYPE, 'username');
            ...
            localStorage.removeItem(STORAGE_KEYS.REMEMBER_EMAIL);
            localStorage.removeItem(STORAGE_KEYS.REMEMBER_USERNAME);
            localStorage.removeItem(STORAGE_KEYS.REMEMBER_LOGIN_TYPE);
        }
    };
    ...
    const toggleLoginType = () => {
        ...
        const rememberedEmail = localStorage.getItem(STORAGE_KEYS.REMEMBER_EMAIL);
        const rememberedUsername = localStorage.getItem(STORAGE_KEYS.REMEMBER_USERNAME);
        const rememberedLoginType = localStorage.getItem(STORAGE_KEYS.REMEMBER_LOGIN_TYPE);
