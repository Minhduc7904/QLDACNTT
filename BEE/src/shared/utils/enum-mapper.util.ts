...
export class EnumMapper {
   ...
   */
  static toPrismaStorageProvider(storageProvider: StorageProvider): PrismaStorageProvider {
   ...
   */
  static fromPrismaStorageProvider(prismaStorageProvider: PrismaStorageProvider): StorageProvider {
